...
class TeeSheet:
    ...
    def send_trigger(self, user_nm, phn_num, num_dys, curr_local_str, tgt1_cs, tgt2_cs, tgt3_cs, tgt4_cs, tgt5_cs, tgt6_cs, tgt7_cs, tgt8_cs, tgt9_cs, tgt10_cs, tgt11_cs, tgt12_cs, tgt13_cs, tgt14_cs, tgt15_cs, tgt16_cs, tgt17_cs, tgt18_cs, tgt19_cs, tgt20_cs,
        ...
        if num_dys >= 1:
            if tgt1_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt1, self.website, self.phone)
            ...
            if tgt2_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt2, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt3_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt3, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt4_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt4, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt5_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt5, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
        if num_dys >= 2:
            if tgt6_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt6, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt7_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt7, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt8_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt8, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt9_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt9, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt10_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt10, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
        if num_dys >= 3:
            if tgt11_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt11, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt12_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt12, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt13_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt13, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt14_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt14, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt15_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt15, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
        if num_dys == 4:
            if tgt16_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt16, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt17_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt17, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt18_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt18, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt19_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt19, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
            if tgt20_cs == curr_local_str:
                msg = create_notification(user_nm, self.tee_sheet_name, tgt20, self.website, self.phone)
                send_message(msg, phn_num)
                print(f'Notification for {self.tee_sheet_name} sent to {phn_num} ({curr_local_str})')
...
while program_running is True:
    ...
    for i in user_acct_tbl.index:
        ...
        if user_acct_tbl.at[i, "ACTIVE"] == 1:
            user_id = user_acct_tbl.at[i, "ID"]
            phone_number = user_acct_tbl.at[i, "PHONE_NUM"]
            user_name = user_acct_tbl.at[i, "FIRST_NAME"]
            day_list_df = user_db.get_user_day_lists(user_id)
            day_list = day_list_df['DAY_LIST'].tolist()
            day_indexes = []
            for a in day_list:
                b = day_dict[a]
                day_indexes.append(b)
            course_list_df = user_db.get_user_course_lists(user_id)
            course_list = course_list_df['COURSE_LIST'].tolist()
            ...
            if 'Lakewood Golf Courses' in course_list:
                ...
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                LakewoodGolf.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str, target_1, target_2, target_3, target_4, target_5, target_6, target_7, target_8, target_9, target_10, target_11, target_12, target_13, target_14, target_15, target_16, target_17, target_18, target_19, target_20)
            ...
            if 'Denver Golf Courses' in course_list:
                ...
                target_times = LakewoodGolf.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                           ...
                                                           target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                LakewoodGolf.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
            ...
            if 'Riverdale' in course_list:
                # Tee Sheet Creation
                Riverdale = TeeSheet("Riverdale", "Starting at 6AM, 8 days in advance", datetime.timedelta(days=7, hours=18), 'https://riverdale.book.teeitup.golf/', '+13036596700')
                target_times = Riverdale.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                           target_7, target_8, target_9, target_10, target_11, target_12,
                                                           target_13, target_14, target_15, target_16, target_17, target_18,
                                                           target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                Riverdale.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                          target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                          target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                          target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                          target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'CommonGround' in course_list:
                ...
                target_times = CommonGround.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                           ...
                                                           target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                CommonGround.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                          target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                          target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                          target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                          target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Broken Tee' in course_list:
                ...
                target_times = BrokenTee.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                           ...
                                                           target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                BrokenTee.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                          target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                          target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                          target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                          target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'DU Golf Course' in course_list:
                ...
                target_times = DUGolf.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                           ...
                                                           target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                DUGolf.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                          target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                          target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                          target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                          target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Foothills Recreation District' in course_list:
                ...
                target_times = FoothillsRec.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                             ...
                                                             target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                FoothillsRec.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Fossil Trace' in course_list:
                ...
                target_times = FossilTrace.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                             ...
                                                             target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                FossilTrace.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Green Valley Ranch' in course_list:
                ...
                target_times = GVR.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                             ...
                                                             target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                GVR.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Hyland Hills' in course_list:
                ...
                target_times = Hyland.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                             ...
                                                             target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                Hyland.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Indian Tree' in course_list:
                ...
                target_times = IndianTree.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                             ...
                                                             target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                IndianTree.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Raccoon Creek' in course_list:
                ...
                target_times = RaccoonCreek.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                                 ...
                                                                 target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                RaccoonCreek.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Saddleback' in course_list:
                ...
                target_times = Saddleback.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                                 ...
                                                                 target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                Saddleback.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
            ...
            if 'Thorncreek' in course_list:
                ...
                target_times = Thorn.get_send_times(num_days, target_1, target_2, target_3, target_4, target_5, target_6,
                                                                 ...
                                                                 target_19, target_20)
                target_1_comp_str, target_2_comp_str, target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str, target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str, target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str, target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str, target_19_comp_str, target_20_comp_str = target_times
                Thorn.send_trigger(user_name, phone_number, num_days, curr_local_time_str, target_1_comp_str, target_2_comp_str,
                                            target_3_comp_str, target_4_comp_str, target_5_comp_str, target_6_comp_str,
                                            target_7_comp_str, target_8_comp_str, target_9_comp_str, target_10_comp_str,
                                            target_11_comp_str, target_12_comp_str, target_13_comp_str, target_14_comp_str,
                                            target_15_comp_str, target_16_comp_str, target_17_comp_str, target_18_comp_str,
